...
// selected number of image
const selectedNumber = document.getElementById("selectedNumber");
const spinner = document.getElementById("spinner");
const notFoundArea = document.getElementById("notFound");
...
const createSlider = () => {
  ...
  // For 0 and (-ve) Value, Default Value: 1000 ms
...
const notFound = (error) => {
  gallery.innerHTML = "";
  notFoundArea.innerHTML = `<h4 class="text-center py-5">${error}</h4>`;
  toggleSpinner();
}
// spinner feature
const toggleSpinner = () => {
